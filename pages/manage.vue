...
export default {
  ...
  methods: {
    ...
    checkPrice() {
      if (
        this.fares.freeKid < 0
				|| this.fares.standardKid < 0
				|| this.fares.standardGroup < 0
				|| this.fares.freeAdult < 0
				|| this.fares.standardAdult < 0
				|| this.fares.bussinessKid < 0
				|| this.fares.bussinessGroup < 0
				|| this.fares.bussinessAdult < 0
      ) {
